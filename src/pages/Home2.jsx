// UPDATED Home.jsx with Formspree Contact Form
// Replace your existing src/pages/Home.jsx with this file
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-slate-50 rounded-sm p-8 shadow-lg">
              ...
              <form 
                action="https://formspree.io/f/xvgerdkv" 
                method="POST" 
                className="space-y-5"
              >
                {/* Hidden field for custom email subject */}
                <input type="hidden" name="_subject" value="New Inquiry from Upscale Home Builders Website" />
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-600 text-white px-8 py-4 rounded-sm hover:bg-amber-700 transition-colors font-semibold text-lg flex items-center justify-center group"
                >
                  Submit Request
                  <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </button>
